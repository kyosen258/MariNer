...
# 加载数据集
train_data = load_data('data/train.json')#[::100]
...
def train_func():
    ...
    for step, batch in enumerate(pbar):
        ...
        avg_f1,avg_prc,avg_rec,cnt = 0,0,0,0
        if step % 1000 == 0 and step != 0:
            ...
            with torch.no_grad():
                ...
                for data in valid_data[0:100]:
                    ...
                    # )
                pbar.close()
                avg_f1,avg_prc,avg_rec = avg_f1/cnt,avg_prc/cnt,avg_rec/cnt
                print('f1:', avg_f1, 'precision:', avg_prc, 'recall:', avg_rec)
